...
// UPI ID — vendor ya admin ka (yahan apna UPI daalo)
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .upi-qr-wrap img { width: 160px; height: 160px; border: 1.5px solid #bee3f8; border-radius: 12px; padding: 8px; background: white; }
    ...
    @media (max-width: 768px) {
      ...
      .steps { gap: 0; flex-wrap: wrap; justify-content: center; }
    ...
    @media (max-width: 480px) {
      ...
      .back-btn { font-size: 0.78rem; padding: 0.4rem 0.8rem; }
        ...
        <div class="address-form">
          ...
          <div style="margin-bottom:1.5rem;">
            ...
            <div style="display:flex;flex-direction:column;gap:0.6rem;" id="savedAddrList">
              ...
              <div class="saved-addr-card <?= $addr['is_default'] ? 'selected' : '' ?>" onclick="selectAddress(<?= $i ?>, this)" data-index="<?= $i ?>"
...
function formatCard(input) {
  ...
  document.getElementById('cardLast4').value = last4;
}
