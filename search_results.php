  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media(max-width:768px){
      ...
      nav{flex-wrap:wrap;height:auto;padding:0.6rem 4vw;gap:0.4rem;}
      .search-wrapper{max-width:100%;margin:0;order:3;flex:0 0 100%;}
      .nav-right{position:fixed;top:0;right:-270px;width:250px;height:100vh;background:var(--white);flex-direction:column;align-items:flex-start;padding:80px 1.2rem 2rem;gap:0.6rem;z-index:200;box-shadow:-8px 0 24px rgba(92,61,30,0.15);transition:right 0.3s;overflow-y:auto;}
