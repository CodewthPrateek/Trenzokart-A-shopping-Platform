...
// Dynamic redirect — works on localhost (/ecommerce/) AND live hosting (/)
$dashboard = (dirname($_SERVER['SCRIPT_NAME']) === '/' ? '' : rtrim(dirname($_SERVER['SCRIPT_NAME']), '/')) . '/assistant/dashboard.php';

if (isset($_SESSION['assistant_id'])) { header("Location: $dashboard"); exit(); }
